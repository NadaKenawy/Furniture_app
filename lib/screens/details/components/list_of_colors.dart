...
class _ListOfColorsState extends State<ListOfColors> {
  int selectedIndex = -1; // قيمة افتراضية تعني عدم تحديد أي عنصر
        ...
        children: [
          ColorsDot(
            ...
            isSelected: selectedIndex ==
                0, // تحديد اللون الأول إذا كان selectedIndex يساوي 0
          ...
          ColorsDot(
            ...
            isSelected: selectedIndex ==
                1, // تحديد اللون الثاني إذا كان selectedIndex يساوي 1
            onSelectedChanged: (selected) {
              setState(() {
          ...
          ColorsDot(
            ...
            isSelected: selectedIndex ==
                2, // تحديد اللون الثالث إذا كان selectedIndex يساوي 2
            onSelectedChanged: (selected) {
              setState(() {
