...
class ColorsDot extends StatelessWidget {
  const ColorsDot({
    ...
    required this.onSelectedChanged, // إضافة callback لتحديث حالة التحديد
  });

  final Color color;
  final bool isSelected;
  final Function(bool) onSelectedChanged; // تعريف callback

  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        onSelectedChanged(!isSelected); // استدعاء callback لتحديث التحديد
      },
      child: Container(
...
class _ListOfColorsState extends State<ListOfColors> {
  List<bool> isSelectedList = [false, false, false]; // قائمة لتتبع التحديد
      ...
      child: Row(
        ...
        children: [
          ColorsDot(
            ...
            isSelected: isSelectedList[0], // استخدام القائمة لتحديد التحديد
          ...
          ColorsDot(
            ...
            isSelected: isSelectedList[1], // استخدام القائمة لتحديد التحديد
            onSelectedChanged: (value) {
              setState(() {
          ...
          ColorsDot(
            ...
            isSelected: isSelectedList[2], // استخدام القائمة لتحديد التحديد
            onSelectedChanged: (value) {
              setState(() {
